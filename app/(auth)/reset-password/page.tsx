      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="border-zinc-800/80 bg-zinc-900/40">
          <CardHeader className="text-center pt-8 border-b-0 pb-0">
            <h2 className="text-xl font-semibold text-zinc-200">New Password</h2>
            <p className="text-xs text-zinc-500 mt-1">Enter your new password below to reset access</p>
          </CardHeader>
          <CardContent className="pt-6">
            <Suspense fallback={
              <div className="flex flex-col items-center justify-center space-y-2 py-8">
                <div className="h-6.5 w-6.5 animate-spin rounded-full border-2 border-emerald-500 border-t-transparent" />
